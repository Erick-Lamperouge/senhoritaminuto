...
const translations={
  pt:{
    ...
    'card.fernando.eyebrow':'EDTECH / ACLS','card.fernando.title':'FERNANDO','card.fernando.desc':'Simulador educacional para treinamento de parada cardiorrespiratória e raciocínio em ACLS.','card.fernando.cta':'Conhecer o projeto','card.fernando.status':'PRONTO',
    'card.jack.eyebrow':'JOGO EDUCACIONAL / SAÚDE','card.jack.title':'Jack-UP','card.jack.desc':'Um jogo educacional em inglês voltado à área da saúde, com desafios e perguntas clínicas sobre fraturas.','card.jack.cta':'Jogar Jack-UP','card.jack.status':'PRONTO',
    ...
    'common.playHereAria':'Dá para jogar diretamente nesta página','common.backTime':'← Voltar no Tempo (Início)','common.aboutProject':'Sobre o projeto','common.goGame':'Ir para o jogo','common.openSimulator':'Abrir simulador ↗','common.playHere':'Dá para jogar aqui','common.playHereSub':'Jogue sem sair do site','common.openOwn':'Abrir em tela própria ↗',
    ...
    'scratch.origin':'Origem','scratch.originText':'O projeto nasceu no Scratch e continua disponível em sua página original, com a mesma experiência que aparece incorporada aqui.','scratch.original':'Abrir projeto original no Scratch','scratch.originalHint':'Ver o projeto na plataforma original',
    'fernando.lead':'Simulador educacional para treinamento de parada cardiorrespiratória e raciocínio em ACLS.',
    'fernando.status':'STATUS','fernando.statusValue':'PRONTO','fernando.focus':'FOCO','fernando.experience':'EXPERIÊNCIA','fernando.experienceValue':'SIMULAÇÃO GUIADA',
    ...
    'jack.format':'FORMATO','jack.formatValue':'JOGO EDUCACIONAL','jack.language':'IDIOMA','jack.languageValue':'APENAS INGLÊS','jack.englishOnly':'O jogo está disponível apenas em inglês.','jack.mascotSoon':'Mascote em breve','jack.content':'CONTEÚDO','jack.health':'FRATURAS · SAÚDE',
    ...
    'mascot.sleep.hidden1':'Dê tempo ao tempo... eu já volto.','mascot.sleep.hidden2':'Preciso descansar um pouquinho.','mascot.sleep.idle1':'Dê tempo ao tempo.','mascot.sleep.idle2':'Que sono... preciso descansar.','mascot.sleep.idle3':'Só vou tirar um cochilo rapidinho.','mascot.wake':'Voltei. Só precisava de um minutinho.',
    ...
    'fernando.line1':'Arigó!','fernando.line2':'Minha família é do sertão. Povo arretado de bom!','fernando.line3':'Bora jogar dominó? Aí a conversa fica séria.','fernando.line4':'Sou muito bom na dama, viu?','fernando.line5':'A primeira fala de Valentina foi “Vovô”. Essa eu guardo comigo.','fernando.interact1':'Oxente, Senhorita Minuto, se eu perder na dama tu volta só um minutinho e deixa eu mexer de novo, visse?','fernando.interact1r':'Oxente nada. Isso é fraude temporal. Perdeu, perdeu.','fernando.interact2':'No sertão, o sol não espera ninguém. Ainda bem que tu toma conta dos minutos.','fernando.interact2r':'Dos minutos eu cuido. No dominó, meu amigo, cada um por si.'
  },
  en:{
    ...
    'card.fernando.eyebrow':'EDTECH / ACLS','card.fernando.title':'FERNANDO','card.fernando.desc':'An educational simulator for cardiac arrest training and ACLS clinical reasoning.','card.fernando.cta':'Explore project','card.fernando.status':'READY',
    'card.jack.eyebrow':'EDUCATIONAL GAME / HEALTH','card.jack.title':'Jack-UP','card.jack.desc':'An English-language educational health game with clinical questions and challenges about fractures.','card.jack.cta':'Play Jack-UP','card.jack.status':'READY',
    ...
    'common.playHereAria':'You can play directly on this page','common.backTime':'← Back in Time (Home)','common.aboutProject':'About the project','common.goGame':'Go to the game','common.openSimulator':'Open simulator ↗','common.playHere':'Play right here','common.playHereSub':'No need to leave the site','common.openOwn':'Open in its own tab ↗',
    ...
    'scratch.origin':'Origin','scratch.originText':'The project was born in Scratch and is still available on its original page, with the same experience embedded here.','scratch.original':'Open the original Scratch project','scratch.originalHint':'View it on the original platform',
    'fernando.lead':'An educational simulator for cardiac arrest training and ACLS reasoning.',
    'fernando.status':'STATUS','fernando.statusValue':'READY','fernando.focus':'FOCUS','fernando.experience':'EXPERIENCE','fernando.experienceValue':'GUIDED SIMULATION',
    ...
    'jack.format':'FORMAT','jack.formatValue':'EDUCATIONAL GAME','jack.language':'LANGUAGE','jack.languageValue':'ENGLISH ONLY','jack.englishOnly':'The game is available in English only.','jack.mascotSoon':'Mascot coming soon','jack.content':'CONTENT','jack.health':'FRACTURES · HEALTH',
    ...
    'mascot.sleep.hidden1':'Give time some time... I will be back.','mascot.sleep.hidden2':'I need a little rest.','mascot.sleep.idle1':'Give time some time.','mascot.sleep.idle2':'So sleepy... I need to rest.','mascot.sleep.idle3':'Just a quick nap.','mascot.wake':'I am back. I just needed a minute.',
    ...
    'fernando.line1':'Arigó!','fernando.line2':'My family is from the sertão. Wonderful people!','fernando.line3':'Want to play dominoes? Now it gets serious.','fernando.line4':'I am very good at checkers, you know?','fernando.line5':'Valentina’s first word was “Grandpa.” I keep that one close.','fernando.interact1':'Hey, Senhorita Minuto, if I lose at checkers, rewind just one minute and let me move again, will you?','fernando.interact1r':'Nice try. That is temporal cheating. A loss is a loss.','fernando.interact2':'In the sertão, the sun waits for no one. Good thing you keep an eye on the minutes.','fernando.interact2r':'I take care of the minutes. At dominoes, my friend, you are on your own.'
  }
};
...
function applyLanguage(lang){
  ...
  document.querySelectorAll('[data-language]').forEach((node)=>{
    if(!(node instanceof HTMLElement))return;
    const selected=node.dataset.language===next;
    node.classList.toggle('active',selected);
    node.setAttribute('aria-pressed',String(selected));
    if(node.getAttribute('role')==='menuitemradio')node.setAttribute('aria-checked',String(selected));
  });
  document.querySelectorAll('[data-language-current-flag]').forEach((node)=>{node.textContent=next==='en'?'🇺🇸':'🇧🇷';});
  document.querySelectorAll('[data-language-current-code]').forEach((node)=>{node.textContent=next==='en'?'EN':'PT';});
